...
const useStyles = makeStyles((c) => ({
  ...
  saintChipName: { fontFamily: fonts.bodyMedium, fontSize: 12, color: c.onAltar, padding: 6, textAlign: "center" },
  input: {
    minHeight: 90,
    borderWidth: 1,
  ...
  typeDesc: { fontFamily: fonts.body, fontSize: 13, color: c.onAltarMuted, marginTop: 2 },
  ...
  simulated: { fontFamily: fonts.body, fontSize: 12, color: c.onAltarMuted, textAlign: "center", marginBottom: spacing.sm },
  ...
  impactSmall: { fontFamily: fonts.body, fontSize: 13, color: c.onAltarMuted, textAlign: "center", marginTop: spacing.lg },
