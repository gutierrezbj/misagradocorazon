...
const useStyles = makeStyles((c) => ({
  ...
  metricLabel: { fontFamily: fonts.body, fontSize: 14, color: c.muted },
  ...
  barLabel: { fontFamily: fonts.body, fontSize: 14, color: c.onSurfaceSecondary, width: 110 },
  ...
  barValue: { fontFamily: fonts.bodySemibold, fontSize: 14, color: c.onSurface, width: 30, textAlign: "right" },
  ...
  tileLabel: { fontFamily: fonts.bodyMedium, fontSize: 14, color: c.onAltar, textAlign: "center" },
}));
